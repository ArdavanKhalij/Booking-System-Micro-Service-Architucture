...
case class property(id: Int, name: String, PropertyType: PropertyType, category: Int, country: String, city: String, var NotAvailable: List[Date], Price: Double)
case class AvailableProperty(id: Int, name: String, PropertyType: PropertyType, category: Int, country: String, city: String, price: Double)
...
case class SendPropertyTypeCountryCity(date: Date, propertyType: PropertyType, country: String, city: String, actorRef: ActorRef)
case class SendPropertyTypeCountryCityName(date: Date, propertyType: PropertyType, country: String, city: String, name: String, actorRef: ActorRef)
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
